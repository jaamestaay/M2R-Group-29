...
\begin{align}
p_i(t_i)=x_i, p_i(t_{i+1})=x_{i+1},\quad\forall i=0,1,\dots,k-1; \tag{\\
p_i'(t_i)=m_i, p_i'(t_{i+1})=m_{i+1},\quad\forall i=0,1,\dots,k-1; \\
p_{i-1}''(t_i)=p_i''(t_i),\quad\forall i=1,\dots,k-1,
\end{align}
