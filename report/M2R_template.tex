...
Since $\forall i=1,\dots,k-1, p_{i-1}''(t_i)=p_i''(t_i)$, we have $2a_{i-1}+6b_{i-1}(t_i-t_{i-1})=2a_i$, which simplifies to be $a_{i-1}+3b_{i-1}\Delta t_i=a_i$.

Using the definition of the coefficients of the Taylor polynomial, we obtain a system of linear equations:
